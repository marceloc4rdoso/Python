...
input_file = 'data/FEV-2024.txt'
output_file = 'data/output.csv'
utils.encoding.normalize_encoding(filepath=input_file)
marcador = "ANDRES ROMANO"

common_information = marcador
accountant_payslips = 0

payslip_fields = dict(header_company={"linha": 0, "coluna_inicio": 0, "coluna_fim": 60},
                      header_local={"linha": 1, "coluna_inicio": 0, "coluna_fim": 60},
                      header_cnpj={"linha": 2, "coluna_inicio": 0, "coluna_fim": 20},
                      header_competence={"linha": 2, "coluna_inicio": 45, "coluna_fim": 100},
